...
urlpatterns = [
    ...
    path('api/surveys/', SurveyView.as_view(), name='survey_list_create'),  # GET - Все опросы, POST - Создание опроса
    path('api/surveys/<int:pk>/', SurveyView.as_view(), name='survey_detail'),  # PUT - Обновление опроса, DELETE - Удаление опроса
]
